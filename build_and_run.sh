...
clang++ ${MORE_FLAGS} -I /usr/local/Cellar/libev/4.20/include/ -I /usr/local/include/ -L /usr/local/Cellar/libev/4.20/lib/ -L /usr/local/lib -std=c++11 main.cpp db_wrapper.cpp -lev -lpthread -lc -lz -lkyotocabinet -lstdc++ -lm -lyaml-cpp
