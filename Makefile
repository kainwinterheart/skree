...
CXXFLAGS = -I /usr/local/Cellar/libev/4.20/include/ -I /usr/local/include/ -I contrib-build/usr/local/include -I contrib-build/usr/lib -std=c++11
...
clean:
	rm -f $(OBJS) $(TARGET)
	cd contrib/yaml-cpp && make clean ||:
