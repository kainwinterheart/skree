...
-I /usr/local/Cellar/libev/4.20/include/ \
-I /usr/local/include/ \
-I contrib-build/usr/local/include \
-I contrib-build/usr/lib -std=c++11 -fstack-protector-all -Wno-expansion-to-defined

# LDFLAGS = -L /usr/local/Cellar/libev/4.20/lib/ -L /usr/local/lib -fsanitize=address,undefined,safe-stack -L contrib-build/usr/local/lib -L contrib-build/usr/lib
